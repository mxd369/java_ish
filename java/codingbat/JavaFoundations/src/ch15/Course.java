...
public class Course implements Serializable
{
	...
	/**
	 * Constructs the courser with the specified information
	 * 
	...
	/**
	 * Constructs the course with the specified information, with no grade established.
	 * 
	 * @param prefix the prefix of the course designation
	 * @param number the number of the course designation
	 * @param title the title of the course
	...
	/**
	 * Determines if this course is equal to the one specified, based on the course designation (prefix and number).
	 * 
