...
/**
 * MazeSolver attempts to recursively traverse a Maze.
 * The goal is to get from the given starting position to the bottom right, following a path of 1's.
 * Arbitrary constants are used to represent locations in the maze that have been TRIED
...
public class MazeSolver
{
	...
	/**
	 * Attempts to recursively traverse the maze. Inserts special characters indication locations
	 * that have been TRIED and that eventually become part of the solution PATH.
	 * 
