...
public class LessonTwentyThree extends JFrame{
    ...
    public static void main(String[] args){
        ...
        new LessonTwentyThree();
        
    }
    
    public LessonTwentyThree(){
        ...
        public void actionPerformed(ActionEvent e){
            ...
            if(e.getSource() == button1){
                ...
                try{
                    ...
                    JOptionPane.showMessageDialog(LessonTwentyThree.this, "Please Enter the Right Info", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                if(dollarSign.isSelected()) {
                    ...
                    JOptionPane.showMessageDialog(LessonTwentyThree.this, numFormat.format(totalCalc), "Solution", JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(LessonTwentyThree.this, totalCalc, "Solution", JOptionPane.INFORMATION_MESSAGE);
